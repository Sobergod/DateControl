package com.chen.schedule.myschedule.customview.calendar;
...
import com.chen.schedule.myschedule.customview.calendar.weekslist.WeekListView;
import com.chen.schedule.myschedule.customview.calendar.weekslist.WeeksAdapter;
import com.chen.schedule.myschedule.models.CalendarEvent;
import com.chen.schedule.myschedule.models.DayItem;
import com.chen.schedule.myschedule.models.WeekItem;
import com.chen.schedule.myschedule.utils.BusProvider;
import com.chen.schedule.myschedule.utils.CalendarManager;
import com.chen.schedule.myschedule.utils.DateHelper;
...
public class CalendarView extends LinearLayout {
    ...
    /**
     * 折叠CalendarView，设置为其只显示一行的高度
     */
    private void collapseCalendarView() {
        MarginLayoutParams layoutParams = (MarginLayoutParams) getLayoutParams();
        int height = (int) (getResources().getDimension(R.dimen.calendar_header_height) + 1 * getResources().getDimension(R.dimen.day_cell_height));
        layoutParams.height = height;
        setLayoutParams(layoutParams);
    }
